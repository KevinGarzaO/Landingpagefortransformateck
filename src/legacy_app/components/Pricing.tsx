  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        {
          text: "✅ Dominio .com incluido ($300)",
          included: true,
          highlight: true,
        },
        {
          text: "✅ Hosting centralizado 1 año",
          included: true,
          highlight: true,
        },
        { text: "Botón WhatsApp integrado", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        {
          text: "✨ Adaptación completa a tu marca",
          included: true,
          highlight: true,
        },
        ...
        { text: "Botón WhatsApp integrado", included: true },
        {
          text: "✨ 3 rondas de cambios incluidas",
          included: true,
          highlight: true,
        },
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Planes transparentes sin costos ocultos. Elige el que mejor se
            adapte a tu etapa
          </p>
        </div>
              ...
              <div className="text-center mb-6 mt-4">
                ...
                <p
                  className={`text-sm mb-6 ${
                    plan.popular ? "text-cyan-100" : "text-gray-400"
                  }`}
                >
                  {plan.description}
                </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl text-white mb-2">
                Sobre el Hosting Centralizado
              </h3>
              <p className="text-gray-300 leading-relaxed">
                Tu web estará alojada en nuestros servidores optimizados, sin
                preocupaciones técnicas ni configuraciones complicadas. Incluye{" "}
                <strong className="text-cyan-400">1 año completo</strong>. La
                renovación anual se cotiza aparte. Si en el futuro deseas
                migrar, es totalmente posible.
              </p>
            </div>
          </div>
        </div>
