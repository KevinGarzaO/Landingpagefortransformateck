    ...
    <div className="pt-20 bg-black">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-500 rounded-full blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 text-center">
          <div className="inline-block px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/50 rounded-full backdrop-blur-sm mb-8">
            <span className="text-cyan-400 text-sm">🚀 LANDING WEB PROFESIONAL</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            {[
              { icon: '⚡', label: 'Entrega 48-72hrs', color: 'from-cyan-400 to-cyan-600' },
              { icon: '🎨', label: 'Diseño Premium', color: 'from-purple-400 to-purple-600' },
              { icon: '📱', label: '100% Responsive', color: 'from-blue-400 to-blue-600' },
              { icon: '🔒', label: 'Hosting Incluido', color: 'from-pink-400 to-pink-600' }
            ].map((feature, i) => (
              <div 
                key={i}
              ...
              >
                ...
                <div className={`text-lg bg-gradient-to-r ${feature.color} bg-clip-text text-transparent`}>
                  {feature.label}
                </div>
              </div>
            ))}
            ...
            {[
              {
                ...
                description: 'Plantillas base adaptadas 100% a tu marca, colores y logo',
                gradient: 'from-cyan-500 to-blue-500'
              },
              {
                icon: '📱',
                title: 'Responsive Design',
                description: 'Perfecto en móviles, tablets y desktop sin excepciones',
                gradient: 'from-blue-500 to-purple-500'
              },
              {
                icon: '🚀',
                title: 'SEO Optimizado',
                description: 'Configuración básica para que Google te encuentre fácilmente',
                gradient: 'from-purple-500 to-pink-500'
              },
              {
                icon: '🌐',
                title: 'Dominio .com',
                description: 'Tu propio dominio profesional incluido en planes Growth y Brand',
                gradient: 'from-pink-500 to-red-500'
              },
              {
                icon: '⚙️',
                title: 'Hosting Premium',
                description: 'Servidores optimizados sin preocupaciones técnicas por 1 año',
                gradient: 'from-orange-500 to-yellow-500'
              },
              {
                icon: '💬',
                title: 'Botón WhatsApp',
                description: 'Conexión directa con tus clientes integrada en todos los planes',
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Únete a cientos de negocios que ya están generando ventas con nuestras landings profesionales
          </p>
