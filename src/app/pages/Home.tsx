...
interface HomeProps {
  onNavigate: (page: 'landing-web') => void;
}
    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500 rounded-full blur-3xl opacity-10 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>

        {/* Geometric Shapes */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-32 h-32 border-2 border-cyan-500/30 rotate-45 animate-spin" style={{ animationDuration: '20s' }}></div>
          <div className="absolute bottom-1/4 right-1/4 w-24 h-24 border-2 border-purple-500/30 rotate-12 animate-spin" style={{ animationDuration: '15s' }}></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          <div className="mb-8 animate-in slide-in-from-bottom duration-700 delay-100">
            <div className="inline-block px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/50 rounded-full backdrop-blur-sm mb-6">
              <span className="text-cyan-400 text-sm md:text-base">⚡ FÁBRICA DE PRODUCTOS DIGITALES</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed animate-in slide-in-from-bottom duration-700 delay-300">
            Transformamos ideas en productos digitales extraordinarios. 
            Desde el concepto hasta el lanzamiento, nuestro equipo de expertos 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto animate-in fade-in duration-700 delay-500">
            {[
              ...
              <div key={i} className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300 group">
      ...
      {/* What We Do */}
      <section id="services" className="py-24 px-4 bg-gradient-to-b from-black via-slate-900 to-black relative overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              No solo desarrollamos. Creamos, diseñamos, optimizamos y lanzamos productos 
            ...
            {[
              {
                icon: '📱',
                title: 'Apps Mobile',
                description: 'Aplicaciones móviles nativas para iOS y Android. Experiencias fluidas y de alto rendimiento.',
                gradient: 'from-purple-500 to-pink-500'
              },
              {
                icon: '💻',
                title: 'Apps Web',
                description: 'Aplicaciones web progresivas (PWA) modernas, rápidas y accesibles desde cualquier navegador.',
                gradient: 'from-blue-500 to-purple-500'
              },
              {
                icon: '🚀',
                title: 'Landing Pages',
                description: 'Páginas de aterrizaje optimizadas para conversión. De la idea al lanzamiento en 48-72hrs.',
                gradient: 'from-cyan-500 to-teal-500'
              },
              {
                icon: '🛒',
                title: 'E-commerce',
                description: 'Tiendas online completas con pasarelas de pago, inventario y gestión de ventas integrada.',
                gradient: 'from-orange-500 to-red-500'
              },
              {
                icon: '⚙️',
                title: 'Sistemas Web',
                description: 'Plataformas personalizadas, CRM, dashboards y herramientas internas para tu negocio.',
                gradient: 'from-indigo-500 to-purple-500'
              },
              {
                icon: '🤖',
                title: 'Chatbot IA WhatsApp',
                description: 'Automatización inteligente con IA para atención 24/7. Respuestas personalizadas y conversacionales.',
                gradient: 'from-green-500 to-emerald-500'
              },
              {
                icon: '✍️',
                title: 'Copywriting para Blogs',
                description: 'Contenido automatizado con agentes de IA. Artículos optimizados SEO que atraen, educan y convierten.',
                gradient: 'from-pink-500 to-rose-500'
              },
              {
                icon: '📊',
                title: 'Marketing Ads',
                description: 'Campañas automatizadas en Google, Meta y más. Estrategias basadas en datos para maximizar ROI.',
              ...
              >
                ...
                {/* Corner Accent */}
                <div className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${service.gradient} opacity-20 blur-2xl group-hover:opacity-30 transition-opacity duration-300`}></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { step: '01', title: 'Consultoría', desc: 'Entendemos tu visión y objetivos', icon: '💡' },
                { step: '02', title: 'Diseño', desc: 'Creamos prototipos profesionales', icon: '🎨' },
                { step: '03', title: 'Desarrollo', desc: 'Construimos con tecnología de punta', icon: '⚙️' },
                { step: '04', title: 'Lanzamiento', desc: 'Ponemos tu producto en marcha', icon: '🚀' }
              ].map((phase, i) => (
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-purple-500 rounded-full blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Únete a cientos de negocios que confiaron en nosotros para crear sus productos digitales
          </p>
