      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed animate-in slide-in-from-bottom duration-700 delay-300">
            Transformamos ideas en productos digitales extraordinarios. Desde el
            concepto hasta el lanzamiento, nuestro equipo de expertos construye
            tu visión con tecnología de vanguardia.
          </p>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              No solo desarrollamos. Creamos, diseñamos, optimizamos y lanzamos
              productos que generan impacto real en tu negocio.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Únete a cientos de negocios que confiaron en nosotros para crear sus
            productos digitales
          </p>
