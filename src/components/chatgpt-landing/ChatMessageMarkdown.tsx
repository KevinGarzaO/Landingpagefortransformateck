...
export function ChatMessageMarkdown({ content }: ChatMessageMarkdownProps) {
  ...
  return (
    <div className="text-[#ECECF1] text-[16px] leading-[1.6] font-['Inter'] font-normal break-words w-full">
      <ReactMarkdown
        components={{
          h1: ({node, ...props}) => <h1 className="text-2xl font-semibold mb-4 mt-6 first:mt-0" {...props} />,
          ...
          a: ({node, ...props}) => <a className="text-[#19C37D] hover:underline" {...props} />,
          blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-[#565869] pl-4 italic mb-4" {...props} />,
